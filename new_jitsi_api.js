		...
		var e = {
				372: (e, t, n) => {
					...
					function m(e) {
						...
						if (!n.host) {
							...
							if (t) {
								const { host: e, hostname: i, pathname: s, port: o } = h(u(`org.jitsi.meet://${t}`));
						...
						constructor() {
							...
							(this.postis = (function (e) {
								...
								var h = {
										...
										send: function (e) {
											var t = e.method;
											(l || e.method === u) && r && 'function' == typeof r.postMessage
												? r.postMessage(JSON.stringify({ postis: !0, scope: n, method: t, params: e.params }), '*')
												: a.push(e);
										},
										ready: function (e) {
											l
										...
										destroy: function (e) {
											clearInterval(t),
												(l = !1),
												i && 'function' == typeof i.removeEventListener && i.removeEventListener('message', p),
												e && e();
										},
									},
								...
								return (
									(t = setInterval(function () {
										h.send({ method: u, params: g });
									}, 50)),
									h.listen(u, function (e) {
										if (e === g) {
											clearInterval(t), (l = !0);
											for (var n = 0; n < a.length; n++) h.send(a[n]);
											a = [];
										} else h.send({ method: u, params: e });
									}),
									h
								);
							})({ ...f, ...e })),
						...
						L = (function (e, t = !1, n = 'hash') {
							...
							return (
								s.forEach((e) => {
									const n = e.split('='),
										r = n[0];
									if (!r || r.split('.').some((e) => d.includes(e))) return;
									let s;
									try {
										if (((s = n[1]), !t)) {
					...
					const S = ['css/all.css', 'libs/alwaysontop.min.js'],
						...
						R = { '_request-desktop-sources': '_requestDesktopSources' };
					let j = 0;
					function I(e, t) {
					...
					function P(e) {
						let t;
						return (
							'string' == typeof e && null !== String(e).match(/([0-9]*\.?[0-9]+)(em|pt|px|((d|l|s)?v)(h|w)|%)$/)
								? (t = e)
					...
					class N extends i() {
						constructor(e) {
							...
							(this._parentNode = c),
								...
								this._createIFrame(a, s, k),
								(this._transport = new w({
									backend: new y({
										postisOptions: {
											allowedOrigin: new URL(this._url).origin,
											scope: `jitsi_meet_external_api_${j}`,
											window: this._frame.contentWindow,
										},
									}),
								})),
								Array.isArray(g) && g.length > 0 && this.invite(g),
								(this._onload = h),
								(this._tmpE2EEKey = b),
						...
						_createIFrame(e, t, n) {
							const r = `jitsiConferenceFrame${j}`;
								...
								switch (t) {
									...
									case 'video-conference-joined':
										if (void 0 !== this._tmpE2EEKey) {
											...
											this.executeCommand('setMediaEncryptionKey', JSON.stringify({ exportedKey: e(this._tmpE2EEKey), index: 0 })),
												(this._tmpE2EEKey = void 0);
										}
										(this._myUserID = r), (this._participants[r] = { email: n.email, avatarURL: n.avatarURL });
									...
									case 'participant-left':
										I(this, -1), delete this._participants[r];
										break;
									...
									case 'prejoin-screen-loaded':
										this._participants[r] = { displayName: n.displayName, formattedDisplayName: n.formattedDisplayName };
										break;
						...
						executeCommand(e) {
							if (e in x) {
								for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++) n[r - 1] = arguments[r];
								this._transport.sendEvent({ data: n, name: x[e] });
						...
						setAudioInputDevice(e, t) {
							return (function (e, t, n) {
								return E(e, { id: n, kind: 'audioinput', label: t });
							})(this._transport, e, t);
						}
						setAudioOutputDevice(e, t) {
							return (function (e, t, n) {
								return E(e, { id: n, kind: 'audiooutput', label: t });
							})(this._transport, e, t);
						}
						...
						setVideoInputDevice(e, t) {
							return (function (e, t, n) {
								return E(e, { id: n, kind: 'videoinput', label: t });
							})(this._transport, e, t);
						}
						startRecording(e) {
				...
				369: (e, t, n) => {
					...
					function i(e, t) {
						(this.logStorage = e),
							...
							Object.values(r.levels).forEach(
								function (e) {
									this[e] = function () {
					...
					(i.prototype.stringify = function (e) {
						...
						(i.prototype._reschedulePublishInterval = function () {
							this.storeLogsIntervalID && (window.clearTimeout(this.storeLogsIntervalID), (this.storeLogsIntervalID = null)),
				...
				7: (e) => {
					...
					function s() {
						...
						if (!(t[s] < e.level))
							for (var a = !(e.options.disableCallerInfo || r.disableCallerInfo) && i(), c = n.concat(e.transports), d = 0; d < c.length; d++) {
								var l = c[d],
									u = l[s];
								if (u && 'function' == typeof u) {
									...
									p.push(new Date().toISOString()),
										e.id && p.push('[' + e.id + ']'),
										a && a.methodName.length > 1 && p.push('<' + a.methodName + '>: ');
									var h = p.concat(o);
									try {
										u.bind(l).apply(l, h);
									} catch (e) {
					...
					(o.setGlobalOptions = function (e) {
						...
						(e.exports = o),
						(o.levels = { TRACE: 'trace', DEBUG: 'debug', INFO: 'info', LOG: 'log', WARN: 'warn', ERROR: 'error' });
				},
				860: (e, t, n) => {
					var r = n(7),
						i = n(369),
